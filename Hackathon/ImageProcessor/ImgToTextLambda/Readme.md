...
* ImgToTextTasks.cs - This class contains the Lambda functions that the Step Function state machine will call.
...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *ImgToTextLambda*):
...
Execute unit tests
```
    cd "ImgToTextLambda/test/ImgToTextLambda.Tests"
    dotnet test
```

Deploy application
```
    cd "ImgToTextLambda/src/ImgToTextLambda"
